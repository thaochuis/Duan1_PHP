                        ...
                        <article class="blog-details">
                                ...
                                <div class="article-action">
                                    <div class="article-tag">
                                        <?php   
                                                ...
                                                echo ' <p> <span>Tên Người bán :</span> '.$ten_nb.'</p> 
                                                        <p> <span>Liên hệ:</span> '.$sdt.'</p>';
                            ...
                            <script>
                                $(document).ready(function(){
                                    $("#binhluan").load("view/binhluan.php", {id_sp: <?=$id?>});

                                });
                            </script>
                            <div class="article-comment-box">
                                <div class="comment-title" id="binhluan">
                                </div>
