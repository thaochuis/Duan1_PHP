                        ...
                        foreach ($dstt as $tt) {
                            ...
                            <div class="single-property wow fadeInUp mb-40" data-wow-delay="0s" data-wow-duration="0s">
                                <div class="property-img">
                                    <a href="'.$linktt.'"  style="width:100%;height:270px;">
                                        <img src="'.$hinh.'" alt="" style="width:100%;height:270px;">
                                    </a>
                                </div>
                                <div class="property-desc">
                                    <div class="property-desc-top">
                                        <h6><a href="'.$linktt.'" pa>'.$tieude.'</a></h6>
                                        <p class="price" style="color: yellow;" >'.$ngaydang.'</p>
                                    ...
                                    <?php 
                                            ...
                                            // var_dump($dmnew);die();
                                                foreach ($dmnewtt as $dm){
                                                    extract($dm);
                                                    $linkdmtt = "index.php?act=tt_dm&iddmtt=".$id;
                                                    echo'
                                    ...
                                    echo'
                                        <div class="single-recent-post fix">
                                            <div class="recent-post-thumbnail">
                                                <a href="'.$linksp.'"><img src="'.$hinh.'" width:100%;height:100px;></a>
                                            </div>
                                            <div class="recent-post-desc">
                                                <div class="post-title">
                                                    <h4><a href="'.$linksp.'">'.$tensp.'</a></h4>
                                                </div>
